...
Using the Math Module for Calculations (math_module_operations.py)
...
Task 1: Read a File and Handle Errors  [read_file.py]
Problem Statement:  Write a Python program that:
...
Task2 :
Problem Statement: Write a Python program that: [read_write_append_files.py]
1.   Takes user input and writes it to a file named output.txt.
2.   Appends additional data to the same file.
3.   Reads and displays the final content of the file.
...
Task 1: Create a Dictionary of Student Marks - [students_marks.py]
...
Expected Output:
Enter Student NameAlice
Alice's marks 85  
Enter Student NameVenkat
Venkat's not found
If the student does not exist in the dictionary:
 
Task 2: Demonstrate List Slicing  - [list_numbers.py]
Problem Statement: Write a Python program that:
